...
storiesOf('Components / Button', module)
  ...
  .add('Primary with icon', () => (
    <Button icon={<Icons.ActionCheckCircle />} onClick={action('clicked')}>
      Primary Button
    </Button>
  ))
  ...
  .add('Primary Square', () => (
    <Button shape={Button.shapes.SQUARE} icon={<Icons.ActionHeart />} onClick={action('clicked')}>
      Primary Button
    </Button>
  ))
  ...
  .add('Primary Round', () => (
    <Button shape={Button.shapes.ROUND} icon={<Icons.ActionSearch />} onClick={action('clicked')}>
      Primary Button
    </Button>
  ))
  .add('Secondary Round', () => (
