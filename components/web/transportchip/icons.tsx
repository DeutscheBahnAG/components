...
const Circle: React.FC<ShapeProps> = ({ fill, children, ...props }) => (
...
const Square: React.FC<ShapeProps> = ({ fill, children, ...props }) => (
  <svg viewBox="0 0 30 30" role="img" {...props}>
...
export const SBahn: React.FC<ShapeProps> = (props) => (
...
export const AKN: React.FC<ShapeProps> = (props) => (
...
export const UBahn: React.FC<ShapeProps> = (props) => (
...
export const Tram: React.FC<ShapeProps> = (props) => (
...
export const Bus: React.FC<ShapeProps> = (props) => (
...
export const Ferry: React.FC<ShapeProps> = (props) => (
