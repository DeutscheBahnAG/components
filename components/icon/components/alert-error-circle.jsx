...
const SvgAlertErrorCircle = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgAlertErrorCircle.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgAlertErrorCircle.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgAlertErrorCircle);
