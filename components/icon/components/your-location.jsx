...
const SvgYourLocation = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgYourLocation.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgYourLocation.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgYourLocation);
