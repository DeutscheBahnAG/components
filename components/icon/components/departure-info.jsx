...
const SvgDepartureInfo = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgDepartureInfo.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgDepartureInfo.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgDepartureInfo);
