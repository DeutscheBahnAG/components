...
const TransportWalking = React.memo(
  React.forwardRef(({ title, titleId, ...props }, svgRef) => (
    ...
    >
      ...
      <style>{'.transport_walking_svg__st0{fill:#3f434c}'}</style>
      <g id="transport_walking_svg__Ebene_1">
        <path
          className="transport_walking_svg__st0"
        ...
        />
        <circle className="transport_walking_svg__st0" cx={12} cy={4} r={2} />
      </g>
    </svg>
  ))
);
