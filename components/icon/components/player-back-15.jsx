...
const SvgPlayerBack15 = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgPlayerBack15.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgPlayerBack15.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgPlayerBack15);
