...
const SvgInfobarKopie = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgInfobarKopie.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgInfobarKopie.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgInfobarKopie);
