...
const SvgWalking = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
  ...
  >
    ...
    <style>{'.walking_svg__st0{fill:#3f434c}'}</style>
    <g id="walking_svg__Ebene_1">
      <path
        className="walking_svg__st0"
      ...
      />
      <circle className="walking_svg__st0" cx={12} cy={4} r={2} />
    </g>
  </svg>
);

SvgWalking.propTypes = {
