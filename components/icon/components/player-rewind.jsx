...
const SvgPlayerRewind = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgPlayerRewind.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgPlayerRewind.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgPlayerRewind);
