...
const SvgDefibrillator = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgDefibrillator.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgDefibrillator.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgDefibrillator);
