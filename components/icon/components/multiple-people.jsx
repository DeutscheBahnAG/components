...
const SvgMultiplePeople = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgMultiplePeople.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgMultiplePeople.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgMultiplePeople);
