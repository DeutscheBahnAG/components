...
const TransportBikesharing = React.memo(
  React.forwardRef(({ title, titleId, ...props }, svgRef) => (
    ...
    >
      ...
      <style>{'.transport_bikesharing_svg__st0{fill:#3f434c}'}</style>
      <g id="transport_bikesharing_svg__Ebene_1">
        <path
          className="transport_bikesharing_svg__st0"
...
TransportBikesharing.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
TransportBikesharing.defaultProps = {
  title: null,
  titleId: null,
};
export default TransportBikesharing;
