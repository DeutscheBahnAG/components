...
const SvgWalkingSwitch = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgWalkingSwitch.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgWalkingSwitch.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgWalkingSwitch);
