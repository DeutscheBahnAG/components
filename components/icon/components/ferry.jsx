...
const SvgFerry = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
  ...
  >
    ...
    <style>{'.ferry_svg__st0{fill:#3f434c}'}</style>
    <g id="ferry_svg__Ebene_1">
      <path
        className="ferry_svg__st0"
...
SvgFerry.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgFerry);
