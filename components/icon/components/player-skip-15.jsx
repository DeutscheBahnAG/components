...
const SvgPlayerSkip15 = ({ title, titleId, ...props }, svgRef) => (
  <svg
    viewBox="0 0 24 24"
    className="dbx-icon"
    width="24"
...
SvgPlayerSkip15.propTypes = {
  title: PropTypes.string,
  titleId: PropTypes.string,
};
SvgPlayerSkip15.defaultProps = {
  title: null,
  titleId: null,
};
const ForwardRef = React.forwardRef(SvgPlayerSkip15);
